...
<body>
    ...
    <section class="wrapper flex flex-col gap-2.5">
        ...
        <div class="flex flex-col gap-4">
            ...
            <!-- Template Card Product (Repeated) -->
            <!-- Bisa dibuat komponen jika pakai Laravel Blade atau Vue/React -->
            <!-- Produk 1 -->
                ...
                <div class="py-3.5 pl-4 pr-[22px] bg-white rounded-2xl flex gap-1 items-center relative">
                    ...
                    <div class="flex flex-wrap items-center justify-between w-full gap-1">
                        <div class="flex flex-col gap-1">
                            ...
                            <p class="text-sm text-grey">{{ $product->price }}</p>
                        </div>
                        <div class="flex">
                            <!-- Star Rating (5 stars) -->
            ...
            @endforelse
            <!-- Produk lainnya tinggal diikuti aja pola di atas -->
            <!-- Enoki Pro, Softovac Bora, Enoki Softovac, dll. -->
